...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _attemptSignUp() {
    if (_isEmailValid && _isPasswordValid) {
      // In a real app, you'd perform actual signup here
      // and then navigate to OTP screen, potentially passing the email
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Align(
                ...
                child: Text(
                  'Sign up',
                  style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black), // Ensure heading is visible
                ),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _isEmailValid && _isPasswordValid ? Colors.black : Colors.grey.shade400,
